                    ...
                    <div className="border border-gray-300 rounded-lg flex items-center justify-between gap-2 ">
                      {item.quantity === 1 ? (
                        <button
                          ...
                          className="border-r border-gray-300 bg-gray-200 cursor-pointer p-2 rounded-l-lg"
                        >
                        ...
                        <button
                          ...
                          className="font-bold border-r border-gray-300 bg-gray-200 cursor-pointer p-2 rounded-l-lg"
                        >
                      ...
                      <button
                        ...
                        className="font-bold border-l border-gray-300 bg-gray-200 cursor-pointer p-2 rounded-r-lg"
                      >
